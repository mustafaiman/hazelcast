...
public class JacksonJsonGetter extends Getter {
    private static final String DELIMITER = "\\.";

    public static final JacksonJsonGetter INSTANCE = new JacksonJsonGetter();

    private JsonFactory factory = new JsonFactory();

    public JacksonJsonGetter() {
        super(null);
    }

    public JacksonJsonGetter(Getter parent) {
        super(parent);
    }
