...
public class JsonWithMetadataTest extends HazelcastTestSupport {
    ...
    public void testWriteRead() {
        ...
        JsonWithMetadata i1 = JsonWithMetadata.create(jsonString);

        Map<Integer, JsonWithMetadata> map = instance.getMap(randomName());
        map.put(1, i1);
    ...
    public void testPredicate() {
        ...
        JsonWithMetadata i1 = JsonWithMetadata.create(jsonString);
        JsonWithMetadata i2 = JsonWithMetadata.create(jsonString2);

        IMap<Integer, JsonWithMetadata> map = instance.getMap(randomName());
        map.put(1, i1);
        map.put(2, i2);

        Collection<JsonWithMetadata> coll = map.values(Predicates.equal("name", "differentName"));
    ...
    public void testPredicate_nested() {
        ...
        JsonWithMetadata i1 = JsonWithMetadata.create(jsonString);
        JsonWithMetadata i2 = JsonWithMetadata.create(jsonString2);
        JsonWithMetadata i3 = JsonWithMetadata.create(jsonString3);
        ...
        Collection<JsonWithMetadata> coll = map.values(Predicates.equal("address.attrs.a", true));
